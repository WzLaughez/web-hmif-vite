...
const Kabinet = () => {
  ...
  <div className="relative min-h-[15vh] w-full " data-aos ="fade-down">
    {/* Content */}
    <div className="relative min-h-screen p-8 flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8 bg-Putih overflow-hidden">
      
      <VideoProfil/>
  {/* Background decorative elements */}
  
  <div className="absolute inset-0 opacity-30">
    <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-Peach rounded-full mix-blend-multiply filter blur-xl animate-pulse"></div>
    ...
    <div className="absolute bottom-1/4 left-1/3 w-96 h-96 bg-Peach rounded-full mix-blend-multiply filter blur-xl animate-pulse delay-2000"></div>
  </div>
  ...
  <div className="relative z-10 flex flex-col items-center justify-center mb-7" data-aos="fade-down">
    ...
    <div className="relative">
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-ungu mb-4 max-w-5xl leading-tight">
        <span className="bg-gradient-to-r from-ungu  to-ungu bg-clip-text text-transparent">
          <Typewriter
    ...
    <div className="relative group">
      ...
      <Link to="/about" className="relative block">
        <div className="relative overflow-hidden rounded-3xl shadow-2xl">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-Peach/20 via-transparent to-transparent"></div>
          
          {/* Floating action button */}
          <div className="absolute bottom-6 right-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            <div className="w-14 h-14 bg-Sage/20 backdrop-blur-sm rounded-full flex items-center justify-center border border-Sage/30 hover:bg-Sage/30 transition-colors duration-300">
  ...
  <div className="relative z-10 w-full max-w-6xl" data-aos="fade-up" data-aos-delay="200">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-4 md:px-8">
      ...
      <Link to="/about" className="group relative">
        <div className="relative bg-Sage/10 backdrop-blur-lg rounded-2xl p-4 border border-SweetDaisy/20 hover:bg-Peach/20 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2">
          <div className="absolute inset-0 bg-gradient-to-br from-ungu/20 to-Peach/20 rounded-2xl opacity-50 group-hover:opacity-100 transition-opacity duration-500"></div>
          
          <div className="relative flex flex-col sm:flex-row items-center gap-6">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-Peach to-Peach rounded-xl blur-md opacity-50 group-hover:opacity-75 transition-opacity duration-300"></div>
              <img 
                src="/Logo_Hijau.png" 
                alt="Philosophy Logo" 
            ...
            <div className="flex-1 text-center sm:text-left">
              <h3 className="text-2xl font-bold text-Sage mb-3 group-hover:text-ungu transition-colors duration-300">
                FILOSOFI LOGO
              </h3>
              <p className="text-Sage/80 leading-relaxed group-hover:text-Sage transition-colors duration-300">
                Temukan makna mendalam di balik identitas visual Kabinet kami
              </p>
              
              <div className="mt-4 flex items-center justify-center sm:justify-start gap-2 text-Sage opacity-50 group-hover:opacity-100 transition-opacity duration-300">
      ...
      <Link to="/about" className="group relative">
        <div className="relative bg-Sage/10 backdrop-blur-lg rounded-2xl p-4 border border-SweetDaisy/20 hover:bg-Peach/20 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2">
          ...
          <div className="relative flex flex-col sm:flex-row items-center gap-6">
            ...
            <div className="flex-1 text-center sm:text-left">
              <h3 className="text-2xl font-bold text-ungu mb-3 group-hover:text-ungu transition-colors duration-300">
                KEMENTERIAN
              </h3>
              <p className="text-Sage/80 leading-relaxed group-hover:text-Sage transition-colors duration-300">
              ...
              <div className="mt-4 flex items-center justify-center sm:justify-start gap-2 text-ungu opacity-50 group-hover:opacity-100 transition-opacity duration-300">
